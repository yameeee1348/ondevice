...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports uart_transmit_button]
...
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {pwm_clk}];#Sch name = JA1
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {dht_11_inout}];#Sch name = JB1
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports {trigger}];#Sch name = JC1
