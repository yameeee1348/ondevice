...
module top_stopwatch (
    ...
    //스탑워치
    wire w_run_stop, w_clear, w_mode, w_start;
    ...
    assign w_dht11_data = (sw[4] == 1) ? w_temperature : w_humidity;
...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    device_sel_mux_4x1  U_DATA_MUX(
    .sel(sw),
    .i_sel0(w_stopwatch_time),
    .i_sel1(w_watch_time_packed),
    .i_sel2(w_dht11_data),
    .i_sel3(w_echo_data),
    .o_mux(w_watch_final_data)
);
    ////수정
...
//     always @(*) begin
//         case (sel)
//             5'b00000: o_mux = i_sel0;
//             5'b00010: o_mux = i_sel1;
//             5'b01000: o_mux = i_sel2;
//             5'b10000: o_mux = i_sel3;
//             default o_mux = i_sel0;
//         endcase
//     end
// endmodule

module device_sel_mux_4x1 (
    input [5:0] sel,         // sw[5:0]
    input [23:0] i_sel0,     // Stopwatch (sw[1]=0)
    input [23:0] i_sel1,     // Clock     (sw[1]=1)
    input [23:0] i_sel2,     // DHT11     (sw[4]=1)
    input [23:0] i_sel3,     // SR04      (sw[5]=1)
    output reg [23:0] o_mux
);
    always @(*) begin
        if (sel[5])      o_mux = i_sel3; // 초음파 우선
        else if (sel[4]) o_mux = i_sel2; // 온습도 우선
        else if (sel[1]) o_mux = i_sel1; // [수정] sw[1]일 때 시계 출력
        else             o_mux = i_sel0; // 기본값 스탑워치
    end
endmodule